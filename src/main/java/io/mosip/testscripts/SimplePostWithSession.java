...
public class SimplePostWithSession extends AdminTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(SimplePostWithSession.class);
	...
	public void test(TestCaseDTO testCaseDTO) throws AuthenticationTestException, AdminTestException {
		...
		if (testCaseDTO.getTemplateFields() != null && templateFields.length > 0) {
			...
			response = postWithBodyAndCookie(ApplnURI + testCaseDTO.getEndPoint(), inputJson, "Authentication",
					".AspNetCore.Session", aspNetCoreSessionId, testCaseDTO.getRole(), testCaseDTO.getTestCaseName());
			Map<String, List<OutputValidationDto>> ouputValid = OutputValidationUtil.doJsonOutputValidation(
